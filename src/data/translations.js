// Translations dictionary for Hassen Arkab's Portfolio
// Allows easy customization of all static copy across EN/FR languages
...
export const translations = {
  en: {
    ...
    aboutSection: {
      ...
      focus: "Focus",
      focusVal: "UX/UI, Branding, Product Design",
      tools: "Tools",
      toolsVal: "Figma, Adobe Suite, HTML/CSS, React basics, AI tools"
    },
    processSection: {
      number: "03",
      title: "Process",
      heading: "/ How I work",
      intro: "Every project is unique, but my core design methodology remains grounded in research, structural validation, interface design and rapid cycles of prototyping. This ensures the output balances technical constraints with real user delight."
    },
    stackSection: {
      title: "/ Stack",
      heading: "Creative Stack & Tools",
      subtitle: "My design & prototyping toolkit"
    },
    contactSection: {
      number: "04",
      title: "Contact",
      heading: "Let’s design something clear, useful and memorable.",
      subheading: "Available for freelance, internships, collaborations and product design projects. Based in Paris, working worldwide.",
    ...
    footer: {
      tagline: "Everything starts with a line.",
  ...
  fr: {
    ...
    aboutSection: {
      ...
      focusVal: "UX/UI, Branding, Product Design",
      tools: "Outils",
      toolsVal: "Figma, Adobe Suite, HTML/CSS, React bases, outils IA"
    },
    processSection: {
      number: "03",
      title: "Méthode",
      heading: "/ Ma méthode",
      intro: "Chaque projet est unique, mais ma méthodologie de conception reste ancrée dans la recherche, la validation structurelle, le design d'interface et des cycles rapides de prototypage. Cela permet d'équilibrer contraintes techniques et satisfaction utilisateur."
    },
    stackSection: {
      title: "/ Stack",
      heading: "Stack créative & Outils",
      subtitle: "Mes outils de conception & de prototypage"
    },
    contactSection: {
      number: "04",
      title: "Contact",
      heading: "Créons ensemble une expérience claire, utile et mémorable.",
      subheading: "Disponible pour des missions freelances, alternances, collaborations et projets de product design. Basé à Paris, travaille dans le monde entier.",
    ...
    footer: {
      tagline: "Tout commence par une ligne.",
